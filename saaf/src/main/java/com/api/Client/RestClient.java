...
public class RestClient {
    ...
    private static final Logger log = Logging.getLogger(RestClient.class);
    ...
    private static RequestSpecification baseRequest() {
        return (RequestSpecification) given().accept(ContentType.JSON).contentType(ContentType.JSON)
                ...
                .header("Authorization", "Bearer " + ConfigEnv.getToken())
    ...
    public static Response show(String Endpoint, String token) {
        log.info("Get request to {}", Endpoint);
        try {
            return baseRequest()
                    .header("Authorization", "Bearer " + token)
